...
public class ChamadoController {
    ...
    public List<Chamado> buscarChamadosPeloStatus(@RequestParam("status") String status){ //o RequestParamn é por estar procurando os parametros da requisição
    ...
    public ResponseEntity<Chamado> cadastrarChamado(@PathVariable Integer idCliente, //através da rota será passado o id do cliente
    ...
    //Vamos mapear o serviço de editar o chamado
    ...
    //para edição, sempre será o método put
...
//AULA DO DIA 28/06/2022 - 29/06/2022