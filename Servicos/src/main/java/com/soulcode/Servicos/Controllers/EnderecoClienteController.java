...
public class EnderecoClienteController {
    ...
    public List<EnderecoCliente> mostrarTodosEnderecos(){
        List<EnderecoCliente> enderecoCliente = enderecoClienteService.mostrarTodosEnderecos();
    ...
    public ResponseEntity<EnderecoCliente> cadastrarEnderecoCLiente(@PathVariable Integer idCliente,
                                                                    @RequestBody EnderecoCliente enderecoCliente){
        try{
            enderecoCliente = enderecoClienteService.cadastrarEnderecoCLiente(enderecoCliente, idCliente);
